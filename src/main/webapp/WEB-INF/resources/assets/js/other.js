		...
		if(searchText.length  > 0 ){
			...
			.then(data =>{
				if(data.length>0){
					...
					const content = '<div class="card"><div class="card-header d-flex justify-content-center align-items-center text-danger"><h1>No Content Available</h1></div></div>'
					educationBlogContainer.innerHTML = content;
				}
