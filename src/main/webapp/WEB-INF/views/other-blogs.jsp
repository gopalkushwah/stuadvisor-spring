...
<body>
			...
			<div class="row">
					...
					<div class="card-body text-center p-4">
						<h2 class="">
							<span class="text-danger fs-1">S</span>earch <span
								class="text-danger fs-1">N</span>on-<span
								class="text-danger fs-1">E</span>ducational <span
				...
				<div class="row">
					<div class="col-sm-12 col-md-12 col-lg-12" id="education-blog-container">
						<!-- Educational blogs by search will appear here...  -->
					</div>
				</div>
			</div>
		</section>
	...
	<!-- End #main -->
<script type="text/javascript" src="<c:url value="/resources/assets/js/other.js"/>"></script>
