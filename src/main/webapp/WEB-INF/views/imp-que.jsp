	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Important Question</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
		...
		<section class="section dashboard">
			<div class="row">
				...
				<div class="card" hidden="true" id="imp-container">
					<div class="card-body" >
						<div class="d-flex justify-content-center mt-3">
							<form class="d-flex justify-content-center w-75">
								<div class="row">
									<div class="d-flex justify-content-center align-item-center flex-wrap" id="set-imp-span">
									</div>
								</div>
							</form>
						</div>
...
<script type="text/javascript"
		src="<c:url value="/resources/assets/js/imp-que.js"/>"></script>
