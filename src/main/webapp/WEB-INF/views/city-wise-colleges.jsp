  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">City Wise Search</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      ...
      <div class="card">
					<div class="card-body text-center p-4">
						<h2 class="">
							<span class="text-danger fs-1">S</span>earch <span
								...
								class="text-danger fs-1">C</span>ity...
						</h2>
						...
						<div class="d-flex justify-content-center mt-3">
							<form class="d-flex w-75" >
								<input type="text" placeholder="Search colleges..."
									class="form-control rounded-start-pill me-1 ps-3 border border-dark" name="cityWise" id="cityWise"/>
								<button class="btn btn-outline-dark rounded-end-pill pe-1" type="button" id="cityWiseBtn">
				...
				<div class="card">
					<div class="card-body" id="city-wise-container" hidden="true">
					<!-- Show Search Result -->
					</div>
				</div>
      </div>
