					...
					<div class="card-body text-center p-4">
						<h2 class="">
							<span class="text-danger fs-1">S</span>earch <span
								class="text-danger fs-1">y</span>our <span
								class="text-danger fs-1">d</span>ream <span
								class="text-danger fs-1">C</span>ollege...
						</h2>
						...
						<div class="d-flex justify-content-center mt-3">
							<form action="" class="d-flex w-75">
								<input type="text" placeholder="Search colleges..."
									class="form-control rounded-5 me-3 p-3 border  border-dark" />
								<button class="btn btn-outline-dark rounded-5 p-3">
